...
" n''est toujours pas réglée, afin d''éviter la restriction de vos appels sortants, prière de vous en acquitter avant le  "  , 
$Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:DUE_DATE)' 
, 'SMS' );
...
$Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:LBC_DATE,
"n''est toujours pas réglée, vos appels sortants risquent la restriction ")' , 'SMS' );
...
INSERT INTO DUNNING_NOTIFICATION VALUES 
('5' , 'SMS5' , '333|concat("Cher client, vos dus s''élèvent à " ,
$Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:OPEN_AMOUNT, 
" DZD, nous vous prions de les payer dans les plus brefs délais." 
)' , 'SMS' );

INSERT INTO DUNNING_NOTIFICATION VALUES 
('6' , 'SMS6' , '333|"Cher client, vos dus ne sont toujours pas payés, prière d''effectuer le paiement dans les 48 heures, votre compte risque la suspension en émission et réception."' ,
 'SMS' );
...
INSERT INTO DUNNING_NOTIFICATION VALUES 
('8' , 'SMS8' , '333|"Cher client, suite au non-paiement de vos factures, nous sommes dans le regret de vous informer que votre compte sera désactivé."' ,
 'SMS' );
 
 /*LES MAILs*/
 INSERT INTO DUNNING_NOTIFICATION VALUES
 ('9' , 'MAIL_RELANCE' , 'ALADJADJ@ooredoo.dz|$Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:CCEMAIL||"OOREDOO : Courier de Relance "|concat(   "Cher client, vos dus s’élèvent à ",
 $Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:OPEN_AMOUNT
," DZD, nous vous prions de les payer dans les plus brefs délais  , Délais : " , 
$Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:DUE_DATE )' , 'MAIL');
 INSERT INTO DUNNING_NOTIFICATION VALUES
 ('10' , 'MAIL_DESACTIVATION' , 'ALADJADJ@ooredoo.dz|$Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:CCEMAIL||"OOREDOO : Courier de Désactivation "|"Cher client, suite au non-paiement de vos factures, nous sommes dans le regret de vous informer que votre compte sera désactivé. "' , 'MAIL');
 
 
 /* SMS SUCRET */
 INSERT INTO DUNNING_NOTIFICATION VALUES 
('12' , 'SMS_SUCRET1' , '"Mehdidou"|"ID = 798 564 974 PWD = 9269 Ba7nour Rubéolla ! ."' ,'SMS' );
