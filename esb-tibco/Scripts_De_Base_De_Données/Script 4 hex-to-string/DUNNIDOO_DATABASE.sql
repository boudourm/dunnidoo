...
('8' , 'SMS8' , '333|concat("Cher client, suite au non-paiement de vos factures, nous sommes dans le regret de vous informer que votre compte sera d",tib:hex-to-string("C3A9" , "UTF-8"),"sactiv",tib:hex-to-string("C3A9" , "UTF-8"),".")' ,
 ...
 /*LES MAILs*/
 INSERT INTO DUNNING_NOTIFICATION VALUES
 ('9' , 'MAIL_RELANCE' , 'ALADJADJ@ooredoo.dz|$Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:CCEMAIL||"OOREDOO : Courier de Relance "|concat(   "Cher client, vos dus s''",tib:hex-to-string("C3A9" , "UTF-8"),"l",tib:hex-to-string("C3A8" , "UTF-8"),"vent ",tib:hex-to-string("C3A0" , "UTF-8")," ",
 $Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:OPEN_AMOUNT
...
$Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:DUE_DATE,".")' , 'MAIL');
 ...
 INSERT INTO DUNNING_NOTIFICATION VALUES
 ('10' , 'MAIL_DESACTIVATION' , 'ALADJADJ@ooredoo.dz|$Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:CCEMAIL||concat("OOREDOO : Courier de D",tib:hex-to-string("C3A9" , "UTF-8"),"sactivation ")|concat("Cher client, suite au non-paiement de vos factures, nous sommes dans le regret de vous informer que votre compte sera d",tib:hex-to-string("C3A9" , "UTF-8"),"sactiv",tib:hex-to-string("C3A9" , "UTF-8"),".")' , 'MAIL');
 
 
 /* NOTIFS SUCRETTES */
 INSERT INTO DUNNING_NOTIFICATION VALUES 
('11' , 'SMS_SUCRET1' , '"0555354165"|"ID = 798 564 974 PWD = 525jpn  YO  ! ."' ,'SMS' );

 INSERT INTO DUNNING_NOTIFICATION VALUES 
('12' , 'MAIL_SUCRET' , 'ALADJADJ@ooredoo.dz|$Start/pfx2:DunningNotification/pfx2:DunningEligibleCustomersInfo/pfx2:CCEMAIL||"YO !!"|"ID = 798 564 974 PWD = 525jpn  YO  !"' ,'MAIL' );



INSERT INTO DUNNING_NOTIFICATION VALUES 
('13' , 'SMS_SUCRET2' , '"DUNNIDOO"|"Stp Tonton Dis Moi si ça marche ."' ,'SMS' );


SELECT * FROM DUNNING_NOTIFICATION